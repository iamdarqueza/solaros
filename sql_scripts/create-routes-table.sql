...
CREATE INDEX IF NOT EXISTS idx_routes_origin_location ON routes USING GIST(origin_location);
CREATE INDEX IF NOT EXISTS idx_routes_destination_location ON routes USING GIST(destination_location);
