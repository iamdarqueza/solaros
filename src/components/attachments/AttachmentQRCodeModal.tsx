...
interface AttachmentQRCodeModalProps {
  isOpen: boolean;
  onClose: () => void;
  serialNumber: string;
...
export default function AttachmentQRCodeModal({
  isOpen,
  onClose,
  serialNumber,
  equipmentName,
  equipmentType
}: AttachmentQRCodeModalProps) {
  ...
  const downloadQRCode = useCallback(async () => {
    try {
      ...
      await toCanvas(canvas, serialNumber, {
        width: 512,
        margin: 2,
        color: {
          dark: '#000000',
